    ...
    return (
      <div className="about-us">
        <p className="about-us__description">
          ...
          and peonies, your chosen scent is what gives your house its
          personality. Bougie offers to you wonderful candles that will bring
          unique and relaxing atmosphere into your home.
        </p>
